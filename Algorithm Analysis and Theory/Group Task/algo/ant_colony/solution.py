...
class Solution(SolutionBase):
    algorithm_id = "ant_colony"  # 算法标识名
    algorithm_name = "Ant Colony"
    ...
    def solve(self):
        ...
        for _ in range(NUM_ITERATIONS):
            ...
            if self.int_data is not None:
                self.int_data["costs"].append(min_cost)
        ...
        return best_path, min_cost, res_int_data
